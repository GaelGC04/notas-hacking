...
## Solución
Se hace nc a la máquina y se da el siguiente texto:
```
...
```
Se descifra con un descifrador de vigenere donde la key puede tener un tama;o de 3 a 15 obteniendo lo siguiente
```
